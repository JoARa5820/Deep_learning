...
# 초기화(initializer)를 xavier_initializer로 적용 
# normal distribution으로 초기값을 주면 cost 값이 높은 상태에서 학습함에 따라 점점 낮아지는데, xavier_initializer를 초기값으로 주면 첫 학습부터 cost값이 낮음 = 초기값이 잘 initialize 되었음을 알 수 있음
