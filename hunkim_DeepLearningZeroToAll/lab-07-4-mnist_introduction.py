...
mnist = input_data.read_data_sets("MNIST_data/", one_hot=True)  # Y(레이블)을 one-hot으로 받아옴
...
# parameters
# 만약 10000개의 데이터셋에서 batch_size를 100으로 잡으면, 100번 돌면 1 에폭임
num_epochs = 15   # 전체 데이터셋을 1번 학습시키는 것 : 1 에폭
batch_size = 100  # 한번에 100개씩 학습시킴
num_iterations = int(mnist.train.num_examples / batch_size)  # mnist.train.num_examples : 전체 데이터 수
