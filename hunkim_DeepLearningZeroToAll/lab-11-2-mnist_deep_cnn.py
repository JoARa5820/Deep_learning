## (1차 : conv-relu-pool) - (2차 : conv-relu-pool) - (3차 : conv-relu-pool) - (fully-connected) - (fully-connected) 구조
...
for epoch in range(training_epochs):
    ...
    for i in range(total_batch):
        ...
        feed_dict = {X: batch_xs, Y: batch_ys, keep_prob: 0.7}  # keep_prob = drop_out : 학습 시 0.7
...
print('Accuracy:', sess.run(accuracy, feed_dict={
      X: mnist.test.images, Y: mnist.test.labels, keep_prob: 1}))  # keep_prob = drop_out : 테스트 시 1
